...
from src.handlers import INVALID_REQUEST, FORBIDDEN, OK
from src.handlers import method_handler
from src.api_requests import ADMIN_LOGIN, SALT,ADMIN_SALT
...
class TestSuite(unittest.TestCase):
    ...
    def test_ok_score_request(self, arguments):
        ...
        self.assertTrue(isinstance(response["score"], (int, float)))
